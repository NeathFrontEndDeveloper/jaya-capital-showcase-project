    ...
    <section className="relative h-[600px] w-full">
      ...
      <div className="relative max-w-6xl mx-auto h-full flex flex-col justify-center px-6 sm:px-12 lg:px-20 text-white">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight max-w-3xl">
          ...
          with <span className="font-bold text-green-700">Expert Renovation </span>
          <br /> Service
        </h1>
        ...
        <div className="mt-8 flex space-x-4">
          <button className="bg-white text-green-800 font-semibold px-6 py-2 rounded-2xl shadow hover:bg-green-500 hover:text-white transition">
            More Info
          </button>
          <button className="bg-green-800 hover:bg-green-500 text-white font-semibold px-6 py-2 rounded-2xl shadow transition">
            Contact Us
          </button>
        </div>
      </div>
